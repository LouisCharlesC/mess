...
namespace
{
  ...
  auto one_node =
      mess::make_graph(mess::make_node<top,
  ...
  auto two_node_arg =
      mess::make_graph(mess::make_node<top,
                       ...
                       mess::make_node<bottom,
                                       mess::arg_predecessors<0>,
                                       mess::other_predecessors<>,
  ...
  auto two_node_unordered =
      mess::make_graph(mess::make_node<bottom,
  ...
  auto v = mess::make_graph(
      ...
      mess::make_node<right,
                      mess::arg_predecessors<>,
                      mess::other_predecessors<>,
                      mess::successors<2>>(func<float>),
      mess::make_node<bottom,
                      mess::arg_predecessors<0, 1>,
                      mess::other_predecessors<>,
